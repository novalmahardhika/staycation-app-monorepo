...
export class Init1740144926569 implements MigrationInterface {
    name = 'Init1740144926569'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_status_enum" AS ENUM('requires_payment_method', 'requires_action', 'amount_capturable_updated', 'succeeded', 'processing', 'payment_failed', 'canceled', 'requires_capture', 'requires_confirmation')`);
        await queryRunner.query(`CREATE TABLE "payments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "stripeId" character varying NOT NULL, "amount" integer NOT NULL, "currency" character varying NOT NULL, "status" "public"."payments_status_enum" NOT NULL, "bookingId" uuid, CONSTRAINT "REL_1ead3dc5d71db0ea822706e389" UNIQUE ("bookingId"), CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`);
